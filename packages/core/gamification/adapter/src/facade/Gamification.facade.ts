import {
    ...
    RegisterGameplay,
    AchievementRule,
    RegisterGameplayInputDTO,
    RegisterGameplayOutputDTO
...
export class GamificationFacade {
    ...
    async registerGameplay(input: RegisterGameplayInputDTO): Promise<RegisterGameplayOutputDTO>{
        const useCase = new RegisterGameplay(
            this.repoPlayer,
        ...
        if (result.failed) {
            console.error("Gamification Error:", result.errors);
            return null;
        }
